...
if __name__ == "__main__":
    ...
    plot(encryption_figure, image='png', image_filename='encryption_compare_image', filename='encryption_compare',
         auto_open=False)
    ...
    plot(decryption_figure, image='png', image_filename='decryption_compare_image', filename='decryption_compare',
         auto_open=False)
